...
\begin{figure*}[!t]
    \centering
    \subfloat[]{\includegraphics[width=0.3\linewidth]{Figures/psf_final_1.png}}%
    \label{fig:psf_a}
    \hfil
    \subfloat[]{\includegraphics[width=0.3\linewidth]{Figures/psf_final_2.png}}%
    \label{fig:psf_b}
    \hfil
    \subfloat[]{\includegraphics[width=0.3\linewidth]{Figures/psf_final_3.png}}%
    \label{fig:psf_c}
...
\begin{figure*}[ht]
    \centering
    \subfloat[]{\includegraphics[width=0.23\linewidth]{Figures/sd_sfd_0.png}}%
    \label{fig:sd_sfd_a}
    \hfil
    \subfloat[]{\includegraphics[width=0.23\linewidth]{Figures/sd_sfd_8.png}}%
    \label{fig:sd_sfd_b}
    \hfil
    \subfloat[]{\includegraphics[width=0.23\linewidth]{Figures/sd_sfd_4.png}}%
    \label{fig:sd_sfd_c}
    \hfil
    \subfloat[]{\includegraphics[width=0.23\linewidth]{Figures/sd_sfd_1.png}}%
    \label{fig:sd_sfd_d}
    \hfil
...
\begin{figure*}[ht]
    \centering
    \subfloat[]{\includegraphics[width=0.23\linewidth]{Figures/sd_sfd_0_w.png}}%
    \label{fig:sd_sfd_a}
    \hfil
    \subfloat[]{\includegraphics[width=0.23\linewidth]{Figures/sd_sfd_8_w.png}}%
    \label{fig:sd_sfd_b}
    \hfil
    \subfloat[]{\includegraphics[width=0.23\linewidth]{Figures/sd_sfd_4_w.png}}%
    \label{fig:sd_sfd_c}
    \hfil
    \subfloat[]{\includegraphics[width=0.23\linewidth]{Figures/sd_sfd_1_w.png}}%
    \label{fig:sd_sfd_d}
    \hfil
...
\begin{figure*}[ht]
    \centering
    \subfloat[]{\includegraphics[width=0.3\linewidth]{Figures/backproj_la.png}}%
    \label{fig:backproj_la}
    \hfil
    \subfloat[]{\includegraphics[width=0.3\linewidth]{Figures/backproj_la_diff.png}}%
...
\begin{figure*}[ht]
    \centering
    \subfloat[]{\includegraphics[width=0.3\linewidth]{Figures/range.png}}%
    \label{fig:range}
    \hfil
    \subfloat[]{\includegraphics[width=0.3\linewidth]{Figures/traj.png}}%
    \label{fig:traj}
    \hfil
    \subfloat[]{\includegraphics[width=0.3\linewidth]{Figures/yaws.png}}%
    \label{fig:yaws}
...
\begin{figure*}[ht]
    \centering
    \subfloat[]{\includegraphics[width=0.3\linewidth]{Figures/mse_bp.png}}%
    \label{fig:range}
    \hfil
    \subfloat[]{\includegraphics[width=0.3\linewidth]{Figures/mse_wbp.png}}%
    \label{fig:traj}
    \hfil
...
\begin{figure*}[ht]
    \centering
    \subfloat[]{\includegraphics[width=0.2\linewidth]{Figures/x.png}}%
    \label{fig:range}
    \hfil
    \subfloat[]{\includegraphics[width=0.2\linewidth]{Figures/y.png}}%
    \label{fig:traj}
    \hfil
    \subfloat[]{\includegraphics[width=0.2\linewidth]{Figures/recon_t.png}}%
    \label{fig:yaws}
    \hfil
    \subfloat[]{\includegraphics[width=0.2\linewidth]{Figures/recon_fft.png}}%
    \label{fig:yaws}
    \hfil
