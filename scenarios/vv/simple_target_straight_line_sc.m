classdef simple_target_straight_line_sc < handle
    ...
    methods
        function obj = simple_target_straight_line_sc(T)
            ...
            obj.target.velocity = [0,-10,0];
            obj.target.body_axis_rotation_vel = repmat([0,0,0], num_scatterers, 1); 
