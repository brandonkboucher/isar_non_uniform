...
classdef Target_Circ < handle
    ...
    methods
        ...
        function obj = Target_Circ(dt, initial_position, num_scatterers)
            ...
            obj.scatter_configuration = ...
                [0, obj.radius(1), 0; ... % scatter 1
                -obj.radius(2), 0, 0; ... % scatter 2
                sqrt(obj.radius(3)^2/2), sqrt(obj.radius(3)^2/2), 0];                 % scatter 3
