...
classdef Target_Straight_Line < handle
    ...
    methods
        ...
        function obj = Target_Straight_Line(dt, initial_position, num_scatterers)
            ...
            % there is only translational velocity as the
            % target travels directly at the radar
