classdef Target_complex_traj_jerk < handle
    ...
    methods
        function obj = Target_complex_traj_jerk(t_slow)
            ...
            initial_yaw = 0;
            initial_yawing_rate = pi/4;
            initial_yawing_acc = -pi;

            % define the yawing jerk
            yawing_jerk_array = 5 * pi * [1, -1, -1, -1];
            ...
            yawing_jerk = zeros(size(t_slow,1),1);
